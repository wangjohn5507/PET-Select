...
def get_largest_and_smallest_physical_loc(dataset, is_humaneval=True):
    largest = 0
    smallest = 100
...
def get_largest_and_smallest_cyclomatic_complexity(dataset, is_humaneval=True):
    largest = 0
    smallest = 100
...
def get_largest_and_smallest_halstead_complexity(dataset, is_humaneval=True):
    largest = 0
    smallest = 100
    for per_data in dataset:
        if is_humaneval:
...
def get_largest_and_smallest_mi(dataset, is_humaneval=True):
    largest = 0
    smallest = 100
    for per_data in dataset:
        if is_humaneval:
...
def get_largest_and_smallest_cognitive_complexity(dataset, is_humaneval=True):
    largest = 0
    smallest = 100
    for per_data in dataset:
        if is_humaneval:
...
def calculate_weighted_complexity(code, is_humaneval=True, is_plus=True):
    ...
    largest_physical_loc, smallest_physical_loc = get_largest_and_smallest_physical_loc(dataset, is_humaneval)
    largest_cyclomatic_complexity, smallest_cyclomatic_complexity = get_largest_and_smallest_cyclomatic_complexity(dataset, is_humaneval)
    largest_halstead_complexity, smallest_halstead_complexity = get_largest_and_smallest_halstead_complexity(dataset, is_humaneval)
    largest_mi, smallest_mi = get_largest_and_smallest_mi(dataset, is_humaneval)
    largest_cognitive_complexity, smallest_cognitive_complexity = get_largest_and_smallest_cognitive_complexity(dataset, is_humaneval)
